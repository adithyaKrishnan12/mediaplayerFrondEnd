    ...
    <div style={{height:'300px'}} className='d-flex justify-content-center align-items-center w-100 flex-column' >
        <div className='d-flex justify-content-evenly align-items-center w-100'>
         ...
         <div className="websites"style={{width:'400px'}}>
                 ...
                 <h6>Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus maiores totam quos esse inventore! Quam adipisci, ipsam praesentium, necessitatibus reprehenderit ducimus quidem magnam quo accusamus perspiciatis sed nobis magni quasi.</h6>
         </div>
        ...
        <p className='mt-5'>copyright © 2023 media Player. Build with react.
        </p>
